...
var Controller = /*#__PURE__*/function () {
  ...
  */
      ...
      case _AppTypes__WEBPACK_IMPORTED_MODULE_8__.STATE_NAMES.exerciseTypes:
        {
          ...
          cLoggerDetail(dataObj);
          this.stateManager.updateItemInState(typeName, dataObj, _framework_util_EqualityFunctions__WEBPACK_IMPORTED_MODULE_15__.isSameMongo, false);
          break;
        }
    }
  };
  ...
  _proto.addExerciseToCurrentWorkout = function addExerciseToCurrentWorkout(exerciseType) {
    ...
    copyOfExercise._id = (0,uuid__WEBPACK_IMPORTED_MODULE_17__["default"])(); // update the id to be unique for the workout
  ...
  _proto.setupValidationForExerciseTypeDetailsForm = function setupValidationForExerciseTypeDetailsForm(form) {
    var rule = {
      ...
      conditions: [{
        ...
        comparison: _framework_ui_form_validation_ValidationTypeDefs__WEBPACK_IMPORTED_MODULE_0__.ComparisonType.hasValue,
        values: 'cardio'
      }]
    };
...
/* harmony import */ var _framework_ui_view_implementation_DefaultPermissionChecker__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../framework/ui/view/implementation/DefaultPermissionChecker */ "./src/framework/ui/view/implementation/DefaultPermissionChecker.ts");
/* harmony import */ var _CurrentWorkoutExercisesView__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./CurrentWorkoutExercisesView */ "./src/app/view/CurrentWorkoutExercisesView.ts");
...
var CurrentWorkoutCompositeView = /*#__PURE__*/function () {
  function CurrentWorkoutCompositeView(sideBar) {
    ...
    this.stateManager = new _framework_state_MemoryBufferStateManager__WEBPACK_IMPORTED_MODULE_8__["default"]();
  ...
  _proto.onDocumentLoaded = function onDocumentLoaded() {
    ...
    if (exerciseTypeDefinition) {
      var exerciseTypeDetailRenderer = new _framework_ui_view_renderer_FormDetailViewRenderer__WEBPACK_IMPORTED_MODULE_2__.FormDetailViewRenderer(_AppTypes__WEBPACK_IMPORTED_MODULE_1__.VIEW_CONTAINER.currentWorkoutDetail, exerciseTypeDefinition, new _framework_ui_view_implementation_DefaultPermissionChecker__WEBPACK_IMPORTED_MODULE_11__.DefaultPermissionChecker());
  ...
  _proto.update = function update(controller, typeName, dataObj) {
    ...
    logger(dataObj);
    this.stateManager.updateItemInState(_AppTypes__WEBPACK_IMPORTED_MODULE_1__.STATE_NAMES.exerciseTypes, dataObj, _framework_util_EqualityFunctions__WEBPACK_IMPORTED_MODULE_9__.isSameMongo, false);
  };

  _proto.delete = function _delete(controller, typeName, dataObj) {
    logger("Deleting exercise from workout from view");
    logger(dataObj);
    this.stateManager.removeItemFromState(_AppTypes__WEBPACK_IMPORTED_MODULE_1__.STATE_NAMES.exerciseTypes, dataObj, _framework_util_EqualityFunctions__WEBPACK_IMPORTED_MODULE_9__.isSameMongo, false);
  };
  ...
  _proto.saveWorkout = function saveWorkout() {
    ...
    _Controller__WEBPACK_IMPORTED_MODULE_6__["default"].getInstance().getStateManager().updateItemInState(_AppTypes__WEBPACK_IMPORTED_MODULE_1__.STATE_NAMES.workouts, this.currentWorkout, _framework_util_EqualityFunctions__WEBPACK_IMPORTED_MODULE_9__.isSameMongo, false);
  };
...
/* harmony import */ var _helper_ValidationHelper__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../helper/ValidationHelper */ "./src/app/helper/ValidationHelper.ts");
/* harmony import */ var _ExerciseTypesViewUsingContext__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ExerciseTypesViewUsingContext */ "./src/app/view/ExerciseTypesViewUsingContext.ts");
...
/***/ "./src/app/view/ExerciseTypesViewUsingContext.ts":
/*!*******************************************************!*\
  !*** ./src/app/view/ExerciseTypesViewUsingContext.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ExerciseTypesViewUsingContext = /*#__PURE__*/function (_AbstractStatefulColl) {
  ...
  function ExerciseTypesViewUsingContext(stateManager) {
    ...
    _this.renderer = new _framework_ui_view_renderer_ListViewRendererUsingContext__WEBPACK_IMPORTED_MODULE_8__.ListViewRendererUsingContext(_assertThisInitialized(_this), _assertThisInitialized(_this));
    _this.eventHandlerDelegate = new _framework_ui_view_delegate_CollectionViewEventHandlerDelegateUsingContext__WEBPACK_IMPORTED_MODULE_9__.CollectionViewEventHandlerDelegateUsingContext(_assertThisInitialized(_this), _this.eventForwarder);
    _this.getIdForItemInNamedCollection = _this.getIdForItemInNamedCollection.bind(_assertThisInitialized(_this));
    _this.getItemId = _this.getItemId.bind(_assertThisInitialized(_this));
...
var WorkoutsViewUsingContext = /*#__PURE__*/function (_AbstractStatefulColl) {
  ...
  _proto.hasPermissionToActionItemInNamedCollection = function hasPermissionToActionItemInNamedCollection(actionName, name, item) {
    console.log(item);
    console.log(actionName + ": " + name + ": " + item.completed);
    var result = false;
...
var BrowserStorageStateManager = /*#__PURE__*/function (_AbstractStateManager) {
  ...
  function BrowserStorageStateManager(useLocalStorage, allowPersistence) {
    var _this;
  ...
  BrowserStorageStateManager.getInstance = function getInstance(useLocalStorage, allowPersistence) {
    if (useLocalStorage === void 0) {
      useLocalStorage = false;
    }
    ...
    if (!BrowserStorageStateManager._instance) {
      BrowserStorageStateManager._instance = new BrowserStorageStateManager(useLocalStorage, allowPersistence);
    }
...
var ChatLogsView = /*#__PURE__*/function (_AbstractStatefulColl) {
  ...
  function ChatLogsView() {
    ...
    _this = _AbstractStatefulColl.call(this, ChatLogsView.DOMConfig, new _state_MemoryBufferStateManager__WEBPACK_IMPORTED_MODULE_5__["default"](), _app_AppTypes__WEBPACK_IMPORTED_MODULE_6__.STATE_NAMES.chatLogs) || this;
...
var UserSearchView = /*#__PURE__*/function (_AbstractStatefulColl) {
  ...
  _proto.eventUserSelected = function eventUserSelected(event, ui) {
    ...
    if (recentUserSearches.length >= UserSearchView.dataLimit) {
      ...
      this.localisedSM.removeItemFromState(_app_AppTypes__WEBPACK_IMPORTED_MODULE_7__.STATE_NAMES.recentUserSearches, item, _util_EqualityFunctions__WEBPACK_IMPORTED_MODULE_1__.isSameMongo, true);
    } // save the searches
  ...
  _proto.itemDeleted = function itemDeleted(view, selectedItem) {
    ...
    this.localisedSM.removeItemFromState(_app_AppTypes__WEBPACK_IMPORTED_MODULE_7__.STATE_NAMES.recentUserSearches, selectedItem, this.compareItemsForEquality, true);
  };
...
UserSearchView.DOMConfig = {
  ...
  resultsClasses: 'list-group-item my-list-item truncate-notification list-group-item-action',
  keyId: '_id',
  keyType: _ConfigurationTypes__WEBPACK_IMPORTED_MODULE_6__.KeyType.number,
  modifiers: {
    normal: 'list-group-item-primary',
    inactive: 'list-group-item-light',
    active: 'list-group-item-info',
