...
export class EncryptedIndexedDBStateManager extends IndexedDBStateManager {
    private static _myInstance: EncryptedIndexedDBStateManager;

    public static getInstance(): EncryptedIndexedDBStateManager {
        if (!EncryptedIndexedDBStateManager._myInstance) {
            EncryptedIndexedDBStateManager._myInstance = new EncryptedIndexedDBStateManager();
        }
        return EncryptedIndexedDBStateManager._myInstance;
    }
