...
export default class BrowserStorageStateManager extends AbstractStateManager implements AsynchronousStateManager {
    protected static _instance: BrowserStorageStateManager;
    protected storage: Storage;
    protected allowPersistence: boolean;
    // @ts-ignore
    protected configuration: string[] = [];

    public constructor(useLocalStorage: boolean = false, allowPersistence: boolean = false) {
        super('browser');
    ...
    public static getInstance(useLocalStorage: boolean = false, allowPersistence: boolean = false) {
